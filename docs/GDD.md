...
- **La nobleza y la Corona** (Acto 3, el Barón) van al extremo opuesto: **refinados, esbeltos y andróginos hasta lo absurdo** — belleza hegemónica pulida como sátira en sí misma (tan perfectos que dan desconfianza). Elegancia excesiva, poses de retrato, ni un pelo fuera de lugar. Dos escuelas dentro de la corte: (a) la **andrógina afilada** (el Barón: líneas limpias, aire casi vampírico), y (b) la **rococó Versalles / María Antonieta**: cara empolvada de blanco (maquillaje de realeza de época, NO de mimo), rubor rosado, lunar postizo, pelucas empolvadas monumentales (con barcos, jaulas o maquinaria de vapor en miniatura dentro), joyas excesivas hasta en los objetos cotidianos, sedas pastel con bordados de latón. En prompts: «18th century French rococo aristocracy, Marie Antoinette court style, white powdered face makeup (period royal makeup, not mime), rouge, beauty mark, towering powdered wig, excessive jewels».
